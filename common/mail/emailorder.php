            ...
            <h2>Order Details :</h2>
             ...
             <div class="wishOrderName" style="margin-left: 170px;">
                 <table class="table1 table border">
                     <tr>
                       <th class="th1 special">Sr No.</th>
                       <!--th class="th1 special">Product Image</th-->
                          <th class="th1 special">Product Name</th>		
                          <th class="th1 special">Quantity</th>
                          <th class="th1 special">Price</th>
                          <th class="th1 special">Subtotal</th>
                          <th class="th1 special">Shipping</th>
                          <th class="th1 special">Delivery_pin</th>
                        </tr>
                     ...
                     <tr>
                          ...
                          <td class="td1"> <?php if($ord["delivery_pin"]!=0){echo $ord["delivery_pin"];}else{ echo '-'; } ?> </td>
                         </tr>

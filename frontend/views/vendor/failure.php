...
<div class="col-xs-12"> <div class="clearfix OrderList">
         <div class="wishDilvrName">
             Sorry, your payment of Rs. <?=$amount?> has been declined by PayUMoney. Your transaction id for this transaction is <?=$txnid?>. 
             You may try making the payment by clicking the link below.
         </div>                             
         </div>
</div>
    <p><b><a href=http://digin.in/testing/frontend/web/index.php> Try Again</a></b></p>
</div>
           <?php } ?>

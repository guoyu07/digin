...
<!-- /*******************For Backend************************/-->
    ...
    <div class="row">
             <div class="col-md-8 col-sm-6 col-xs-12">
                <?php echo $form->field($model, 'googleaddr')->textInput(['id'=>'googleaddress1']);  ?>
            </div>
        </div>
        <div class="row">
          <div class="col-md-4 col-sm-6 col-xs-12">
              <div class="mT20"></div>
              <?php  echo Html::button('Hide Map',array('id'=>'showmap', 'class'=>'btn btn-primary')); 
                     echo Html::button('Locate',array('id'=>'loc', 'class'=>'btn btn-primary locbtn')); 
              ?>
          </div> 
            <div class="col-md-4 col-sm-6 col-xs-12">
                <?php
                echo $form->field($model, 'location')->textInput(['id'=>'latlng','readonly'=>true]);
                 ?>
           </div> 
        </div> 
    ...
    <?php 
     ...
     <div class="row">
        ...
        echo Html::label('Add Facilities');
     ...
     <div class="mtt10"></div>
         <div class="col-xs-6"> 
			       <?php echo Html::Button('',['id'=>'btnAdd','class'=>'btn btndefault btnflt']); ?>
		     </div>
         <div class="col-xs-6"> 
        ...
        <div class="col-md-4 col-sm-5 col-xs-12">
        <?php //$data=array();
		 echo Html::label('Selected Facilities');
...
<!--     <div class="row">
    ...
    <fieldset class="scheduler-border">
			<legend class="scheduler-border">Delivery Options</legend>
     <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">        
           <?php $data=['1'=>'Digin delivery world wide','2'=>'I will deliver my products world wide','3'=>'I will delivered within'];
           echo $form->field($model, 'delivryopt')->radioList($data)->label(FALSE); ?>
        </div>
         
        
         <div class="col-md-2 col-sm-6 col-xs-12" style="margin-top: 7%;">
             <span><input type="text" name="kms" class="form-control" style="width:42%;"></span>
             
        </div>

         <div id="kmfld"> <!-- /*style="display:none;"*/-->
          <div class="col-md-3 col-sm-6 col-xs-12"  style="margin-top: 7%;">
             <span><b>kms for min order of</b></span>
         </div>
          <div class="col-md-2 col-sm-6 col-xs-12">
              <input type="text" name="minorderkms"  class="form-control" style="margin-top: 49%;">
          </div>  
         </div>
         </div>
         <!------------------------------------------>
    ...
    <div class="row">
          ...
          <div class="col-md-2 col-sm-6 col-xs-12">
              <span><b>my city</b></span>
          <?php //echo $form->field($mdlspcdlvroptn, 'delivery_limit')->dropDownList(['select'=>'-Select value-','1' => 'Kms', '2' => 'City','3' => 'Country'], ['style' => 'background:gray;color:#fff;float:left;']); ?>         
        </div>
         ...
         <div id="kmfld"> <!-- /*style="display:none;"*/-->
          ...
          <div class="col-md-2 col-sm-6 col-xs-12">
              <input type="text" name="minordercity"  class="form-control">
          </div>  
         </div>
    </div>
         <!------------------------------------------>
      <div class="row">
         ...
         <div id="kmfld"> <!-- /*style="display:none;"*/-->
          ...
          <div class="col-md-2 col-sm-6 col-xs-12">
              <input type="text" name="minordercountry"  class="form-control">
          </div>  
         </div>
    </div>
...
<?php //if($userRole=='Admin' && $userRole=='Vendor') { ?>
    <div class="row" style="display:none;" id="backdetail">
        <div class="col-md-8 col-sm-6 col-xs-12">  
    <fieldset class="scheduler-border">
   ...
   <div class="row">
            <div class="col-md-8 col-sm-6 col-xs-12">         
           <?php echo Html::checkbox('agree', FALSE, ['label' => 'I agree to Digin <a href="index.php?r=site/termscondven" target="_blank">terms of services</a> and <a href="index.php?r=site/privacypolven" target="_blank">privacy policy</a>.','class'=>'chkacpt acceptline']);?>
             </div>
      </div>
...
function initMap() {    
 ...
 var latlng = {lat: parseFloat(latlngStr[0]), lng: parseFloat(latlngStr[1])};
  ...
  if (navigator.geolocation) {
    ...
    var inputaddr= document.getElementById('googleaddress1'); 
  ...
  function locateAddress(){   
    autocomplete.bindTo('bounds', map);
      ...
      if(place==null){
       ...
       var address = document.getElementById('googleaddress1').value;
       geocoder.geocode({'address': address}, function(results, status) {
        ...
        if(document.getElementById('googleaddress1').value!=null && document.getElementById('googleaddress1').value!=''){
        if (!place.geometry) {
          window.alert("Place not found. Please check your address.");
          return;
        }
  ...
  geocoder.geocode({'location': latlng}, function(results, status) {
    if (status === google.maps.GeocoderStatus.OK) {
      if (results[1]) {
		...
		document.getElementById('googleaddress1').value=results[1].formatted_address;

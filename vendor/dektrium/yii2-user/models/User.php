...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            'register' => ['username', 'email', 'password','phone','role'], // phone, role are new
            'connect'  => ['username', 'email'],
            'create'   => ['username', 'email', 'password', 'phone'],
            'update'   => ['username', 'email', 'password','phone','role'], // phone, role are new
    ...
    public function rules()
    {
        return [
            ...
            [['phone','role'], 'required', 'on' => ['register']],  // new
    ...
    public function register()
    {
        ...
        if ($this->save()) {
            $auth->assign($auth->getRole($role),$this->getId()); //new 
    ...
    protected function getFlashMessage()
    {
        if ($this->module->enableGeneratingPassword && $this->module->enableConfirmation) {
          ...
          return \Yii::t('user', 'Thank you for showing interest in registering with digin.in. You have been sent
            login details by email and SMS. Your registration will be processed shortly and you
            will be informed accordingly by email and SMS. Regards digin.in team'); 
        } else {

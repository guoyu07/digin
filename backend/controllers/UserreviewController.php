...
class UserreviewController extends Controller
{
    ...
    {        
        ...
        $userreviewcmnt->crtby=Yii::$app->user->identity->id; 
        $userreviewcmnt->upddt=date('Y-m-d H:i:s');
        $userreviewcmnt->updby=Yii::$app->user->identity->id;        
        ...
        {            
            if(strpos($r,'q_') !== false)
            {
              ...
              $userreview->crtby=Yii::$app->user->identity->id; 
              $userreview->upddt=date('Y-m-d H:i:s');
              $userreview->updby=Yii::$app->user->identity->id;              

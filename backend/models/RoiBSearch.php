...
/**
 * RoiBSearch represents the model behind the search form about `backend\models\RoiB`.
 */
class RoiBSearch extends RoiB
{
    ...
    {
        $query = RoiB::find()->groupBy('dpid')->where(['roib.dpid'=>$dpid]);
        $query->joinWith(['deliverypartner','cities']);         //deliverypartner - name of relation given in model

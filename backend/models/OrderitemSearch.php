...
class OrderitemSearch extends Orderitem
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            [['vpid','vendor','vendor_pay_date','status',], 'safe'],//'upddt''crtdt'
        ];
    }
    ...
    public function search($params)
    {
      ...
      foreach ($vpids as $vp){
       ...
       //$query->joinWith('vendor_products vp');
      // $query->andFilterWhere(['like', 'vendor_products.vpid', $this->getVendorNm('vendor_products.vpid')]);
        ...
        $query->andFilterWhere([
            ...
            'upddt' => $this->upddt,
            'updby' => $this->updby,
            //'vendor_pay_date'=> $this->vendor_pay_date,
         ]);
       ...
       // $query->andFilterWhere(['between','orderitem.crtdt',$frmnw[0],$frmnw[1]]);
        ...
        /////when vendor is login thyen search result will be...
        $query = Orderitem::find();
...
//        if((array_keys($userRole)[0]=='Vendor')){
        $vid = Vendor::findOne(['user_id'=>Yii::$app->user->identity->id]);
        $vpids = VendorProducts::find()->where(['vid'=>$vid['vid']])->one();
        //$vpid = array();
//      foreach ($vpids as $vp){
//               array_push($vpid, $vp['vpid']);
//      }

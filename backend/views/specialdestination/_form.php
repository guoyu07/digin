...
<div class="specialdestination-form">
...
<script type="text/javascript">
     $(document).ready(function(){
         $('#specialdestination-state').change(function(){            
            var state=$('#specialdestination-state').val();
            //alert(state);
             $.ajax({
                type:"POST",
                   url:"index.php?r=specialdestination/getcity",           
                   data:{stateid:state},

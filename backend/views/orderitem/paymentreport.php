    ...
    <div class="col-md-6">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <p><a href="index.php?r=orderitem/export<?php echo $nwquery; ?>" id="export" value="<?php //echo Yii::$app->request->getQueryParams(); ?>"><img style="height:40px;width: 40px;" src="<?php echo 'https://www.digin.in/images/Excel_Icon.png';?>"/></a></p>
...
<?php //ActiveForm::end(); ?>
 ...
 <?php $this->registerJsFile('testing/backend/web/js/orderitempay.js', ['depends' => [\yii\web\JqueryAsset::className()]]);?>
